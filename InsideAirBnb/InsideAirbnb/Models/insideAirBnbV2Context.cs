...
{
    public partial class insideAirBnbV2Context : DbContext
    {
        public insideAirBnbV2Context()
        {
        }

        public insideAirBnbV2Context(DbContextOptions<insideAirBnbV2Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=localhost;Database=insideAirBnbV2;Trusted_Connection=True;");
            }
        }
